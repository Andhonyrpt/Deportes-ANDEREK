...
router.post('/register',
    [
        body('displayName')
            ...
            .matches(/^[a-zA-Z0-9\s]+$/).withMessage('displayName must contain only letters, numbers ad spaces'),
        ...
        body('phone')
            ...
            .isLength({ min: 10, max: 10 }).withMessage('Phone must eb exactly 10 digits')
